        ...
        <section class="container-color-editform">
            <div class="container">
                <?php
                    ...
                    if (isset($_GET['id']))
                    {
                        $_SESSION['editIdManager'] = $_GET['id'];
                    }

                    $ar = $con->query("SELECT * FROM `clientAccounts`, `branch` WHERE `clientAccounts`.`id` = '$_SESSION[editIdManager]' AND `clientAccounts`.`branch_id` = `branch`.`branch_id` LIMIT 1");
                    $userData = $ar->fetch_assoc();
                    ...
                    if (isset($userData))
                    {
                        ?>
                            ...
                            <form action="../backend/form.php?user=manager&editId=<?php echo $_SESSION['editIdManager'] ?>" method='POST' class='form-control'>
                                <div class='col'>
